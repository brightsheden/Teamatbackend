...
def uploadAgricImage1(request):
    ...
    agricProduct_id=data['agricProduct_id']
    agricProduct =  AgricProduct.objects.get(_id=agricProduct_id)
    agricProduct.image1 = request.FILES.get('image')
    agricProduct.save()
...
def uploadAgricImage2(request):
    ...
    agricProduct_id=data['agricProduct_id']
    agricProduct =  AgricProduct.objects.get(_id=agricProduct_id)
    agricProduct.image2 = request.FILES.get('image')
    agricProduct.save()
    return Response("image2 was uploaded")
...
def uploadAgricImage3(request):
    ...
    agricProduct_id=data['agricProduct_id']
    agricProduct =  AgricProduct.objects.get(_id=agricProduct_id)
    agricProduct.image3 = request.FILES.get('image')
    agricProduct.save()
...
def uploadInformationThumbnail(request):
    ...
    informationTechProduct_id=data['informationTechProduct_id']
    informationTechProduct =  InformationTechProduct.objects.get(_id=informationTechProduct_id)
...
def uploadinformationTechImage1(request):
    ...
    informationTechProduct_id=data['informationTechProduct_id']
    informationTechProduct =  InformationTechProduct.objects.get(_id=informationTechProduct_id)
    informationTechProduct.image1 = request.FILES.get('image')
    informationTechProduct.save()
    return Response("image1 was uploaded")
...
def uploadinformationTechImage2(request):
    ...
    informationTechProduct_id=data['informationTechProduct_id']
    informationTechProduct =  NaturalProduct.objects.get(_id=informationTechProduct_id)
    informationTechProduct.image2 = request.FILES.get('image')
    informationTechProduct.save()
    return Response("image2 was uploaded")
...
def uploadinformationTechImage3(request):
    ...
    informationTechProduct_id=data['informationTechProduct_id']
    informationTechProduct =  NaturalProduct.objects.get(_id=informationTechProduct_id)
    informationTechProduct.image3 = request.FILES.get('image')
    informationTechProduct.save()
    return Response("image2 was uploaded")
