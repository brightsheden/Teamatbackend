...
urlpatterns = [
    ...
    path("informationTech/informationsproducts/", getInformationTechProduct, name="getinformationtechs"),
    ...
    path("informationTech/<str:pk>/informationtechproduct/", getInformationTechProducByid, name="informationtechproduct"),
    path("informationTech/<str:pk>/update/", UpdateInformationTechProduct, name="updateinformationTechProduct"),
    path("informationTechProduct/<str:pk>/delete", DeleteInformationTechProduct, name="deleteinformationTechProduct"),
    ...
    path('booking/<str:pk>/delebooking/', deleteBooking, name="deletebooking")
